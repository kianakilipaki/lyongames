...
const Hero: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-[10%] w-8 h-8 bg-game-purple rounded opacity-60 animate-float" style={{ animationDelay: '0s' }}></div>
      <div className="absolute top-40 right-[15%] w-12 h-12 bg-game-pink rounded opacity-60 animate-float" style={{ animationDelay: '1.5s' }}></div>
      <div className="absolute bottom-32 left-[20%] w-6 h-6 bg-game-cyan rounded opacity-60 animate-float" style={{ animationDelay: '3s' }}></div>
      <div className="absolute bottom-40 right-[25%] w-10 h-10 bg-game-yellow rounded opacity-60 animate-float" style={{ animationDelay: '4.5s' }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-4 relative inline-block">
            <div className="w-48 h-48 md:w-64 md:h-64 mx-auto relative">
              <div className="w-full h-full bg-[url('https://images.pexels.com/photos/2103127/pexels-photo-2103127.jpeg')] bg-contain bg-center bg-no-repeat" style={{ imageRendering: 'pixelated', filter: 'brightness(1.2) contrast(1.1)' }}></div>
            </div>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
          <span className="font-pixel text-xs text-game-cyan mb-2">SCROLL DOWN</span>
